$(document).ready(function(){
	...
	$('#logoutLink').on('click', function(event){
	 ...
	 var idCell = $('#idCell');
	 var korisnickoImeCell = $('#korisnickoImeCell');
	 var lozinkaCell = $('#lozinkaCell');
     var datumRegCell = $('#datumRegCell');
     var ulogaCell = $('#ulogaCell');
	
 	
 	function getKorisnik() {
 		$.post('ProfilKorisnikaServlet', {'action': 'get', 'id' : idCell.val()}, function(data) {
 			console.log(data);
